...
// WithDefaults hydrates default values in the get tokens params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetTokensParams) WithDefaults() *GetTokensParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get tokens params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetTokensParams) SetDefaults() {
...
// WithUserID adds the userID to the get tokens params
func (o *GetTokensParams) WithUserID(userID string) *GetTokensParams {
	o.SetUserID(userID)
	return o
}

// SetUserID adds the userId to the get tokens params
func (o *GetTokensParams) SetUserID(userID string) {
	o.UserID = userID
}
